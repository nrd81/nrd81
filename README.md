...
🏠 Homelab as proof — a 3-node Proxmox cluster run like production: 20+ services as code, zero-trust ingress, and a working human-in-the-loop AI ops pattern where an AI agent proposes infrastructure changes as pull requests I approve from my phone → homelab-infra
...
| fantasy-warehouse *(private — write-up coming)* | End-to-end data pipeline: API ingest → Postgres warehouse → SQL analytics → dashboard |
